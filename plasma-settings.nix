{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-13296431-d0c4-4c9f-9148-cb5f77c8f622" = [ ];
    ...
    configFile = {
      ...
      "dolphinrc"."General"."ViewPropsTimestamp" = "2024,2,28,16,13,25.805";
      "dolphinrc"."KFileDialog Settings"."Places Icons Auto-resize" = false;
      "dolphinrc"."KFileDialog Settings"."Places Icons Static Size" = 22;
      "kactivitymanagerdrc"."activities"."13296431-d0c4-4c9f-9148-cb5f77c8f622" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "13296431-d0c4-4c9f-9148-cb5f77c8f622";
      "kcminputrc"."Libinput/1739/32382/DELL07EB:00 06CB:7E7E Touchpad"."NaturalScroll" = true;
      ...
      "kwinrc"."Desktops"."Id_1" = "6b90b8cc-cca1-4d88-a424-ff083358cedf";
      "kwinrc"."Desktops"."Number" = 1;
      "kwinrc"."Desktops"."Rows" = 1;
      "kwinrc"."Effect-overview"."BorderActivate" = 9;
      "kwinrc"."Tiling"."padding" = 4;
      "kwinrc"."Tiling/89483b5b-738f-53ba-a71a-de2513a79b76"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      ...
      "spectaclerc"."ImageSave"."lastImageSaveLocation" = "file:///home/matthisk/Pictures/Screenshots/Screenshot_20250123_001012.png";
