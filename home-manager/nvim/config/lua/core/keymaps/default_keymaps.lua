...
local M = {
    ...
    { mode = { "n", "t" }, lhs = "<c-h>",    rhs = "<c-w>h",                      opts = { desc = "Go to left window" } },
    { mode = { "n", "t" }, lhs = "<c-j>",    rhs = "<c-w>j",                      opts = { desc = "Go to lower window" } },
    { mode = { "n", "t" }, lhs = "<c-k>",    rhs = "<c-w>k",                      opts = { desc = "Go to upper window" } },
    { mode = { "n", "t" }, lhs = "<c-l>",    rhs = "<c-w>l",                      opts = { desc = "Go to right window" } },
